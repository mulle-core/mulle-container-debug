...
if( COLLECT_DEPENDENCY_LIBRARIES_AS_NAMES)
   ...
   if( NOT MULLE__BUFFER_LIBRARY)
      foreach( _TMP_MULLE__BUFFER_LIBRARY_TARGET mulle-buffer)
         if( TARGET ${_TMP_MULLE__BUFFER_LIBRARY_TARGET})
            set( MULLE__BUFFER_LIBRARY ${_TMP_MULLE__BUFFER_LIBRARY_TARGET})
            break()
         endif()
      endforeach()
      if( NOT MULLE__BUFFER_LIBRARY)
   ...
   if( MULLE__BUFFER_LIBRARY)
         ...
         #
         if( NOT ${MULLE__BUFFER_LIBRARY} IN_LIST DEPENDENCY_LIBRARIES)
...
#
if( COLLECT_DEPENDENCY_LIBRARIES_AS_NAMES)
   list( APPEND DEPENDENCY_LIBRARIES "mulle-sprintf")
else()
   ...
   if( MULLE__SPRINTF_LIBRARY)
         ...
         #
         if( NOT ${MULLE__SPRINTF_LIBRARY} IN_LIST DEPENDENCY_LIBRARIES)
